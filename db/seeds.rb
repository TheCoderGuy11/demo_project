...
#0..40.times do 
# Product.create(name: Faker::Device.model_name, price: Faker::Commerce.price, brand_name: Faker::Device.manufacturer, user_id: (1..5).to_a.sample, quantity: (1..10).to_a.sample, delivery_time_attributes: {number_of_days: (1..10).to_a.sample})
#end
...
#0..25.times do 
#  ProductDetail.create(category_id: (1..3).to_a.sample, product_id: (1..40).to_a.sample, sub_category_id: (1..6).to_a.sample)
#end
#puts "all done"